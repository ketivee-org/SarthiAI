...
=======
# Project goal
1. For Software company or indivisual
   Ketivee goal to help indivisual and enterpricess to create powerfull program Using Sarthi AI.
   fix issue in their program and make them more stable. 

   Improve goverment website and make them more secure, scalable, and user freindly.
   Give goverment more control on their data and give easy to manage their site.
